#This code is developed by Mahima Prasad Nayak
import random
...
class HandCricketGame:
    ...
    def toss(self, toss_result):
        ...
        print(f"Computer choose {T2} for toss")
        toss_sum = T1 + T2
        if toss_sum % 2 == 0:
            if toss_result == 1:
...
def main():
    ...
    game.play()
    print("Thankk you for playing!!Come soon next time.")
